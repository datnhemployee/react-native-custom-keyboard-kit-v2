...
class Keyboard extends React.PureComponent {
  ...
  init = (keyboardType) => {
    ...
    if (LIST_KEYBOARDS[keyboardType]) {
      LIST_KEYBOARDS[keyboardType].tag = tag;
    }
  };
 ...
 *
 */
const attach = async (inputRef, keyboardType, modalRef, viewRef) => {
  ...
  await NativeKeyboardKit.attach(inputId, keyboardType, modalId, viewId);
